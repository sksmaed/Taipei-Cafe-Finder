                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                    <div className="p-8 md:p-10">
                        ...
                        <div className="mb-12">
                            ...
                            <div className="relative bg-brand-secondary/20 p-5 rounded-lg border border-gray-100">
                                <p
                                    className={`text-gray-700 font-light leading-relaxed transition-all duration-300 ${
                                ...
                                <button
                                    ...
                                    className="mt-3 text-xs font-bold uppercase tracking-widest text-brand-accent"
                                >
                        ...
                        {/* Menu Section */}
                        <div className="mb-12">
                            <h3 className="text-xs font-bold text-gray-900 uppercase tracking-[0.2em] mb-6 border-b border-gray-100 pb-2">
                                Menu Highlights
                            </h3>
                            
                            <div className={`grid gap-4 transition-all duration-300 ${menuExpanded ? "" : "max-h-80 overflow-hidden"}`}>
                                {cafe.menu.map(item => (
                                <div key={item.id} className="flex items-center justify-between p-4 rounded-lg border border-gray-50 hover:border-gray-100 hover:shadow-sm transition-all group bg-white">
                                    <div className="flex-1 pr-4">
                                        <div className="flex items-baseline gap-2 mb-1">
                                            ...
                                            <span className="text-xs text-gray-400 font-light border border-gray-100 px-1.5 py-0.5 rounded">
                                                {item.category}
                                            </span>
                                        </div>
                            ...
                            {cafe.menu.length > 4 && (
                                <button
                                    ...
                                    className="mt-3 text-xs font-bold uppercase tracking-widest text-brand-accent"
                                >
                                    {menuExpanded ? "Show Less" : "View More"}
                                </button>
                            )}
                        </div>
                        ...
                        <div className="mb-16">
                            ...
                            {/* Auto Review Summary
                            <p className="text-gray-500 text-sm font-light mb-4 italic">
                                {cafe.menu.length === 0
                                    ? "No menu information available."
                                    : `Featuring specialties like ${cafe.menu.slice(0, 3).map(i => i.name).join(", ")}, crafted to complement the café’s ambiance.`}
                            </p> */}

                            <div className={`space-y-6 transition-all duration-300 ${reviewExpanded ? "" : "max-h-80 overflow-hidden"}`}>
                                ...
                                {/* Keep your existing AI Review Generator */}
                            ...
                            {localReviews.length > 3 && (
                                <button
                                    ...
                                    className="mt-3 text-xs font-bold uppercase tracking-widest text-brand-accent"
                                >
                                    {reviewExpanded ? "Show Less" : "View More"}
                                </button>
                            )}
                        </div>
